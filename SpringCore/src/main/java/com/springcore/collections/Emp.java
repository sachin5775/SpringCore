...
public class Emp {
	...
	private LinkedList<String> empCitys;
	 ...
	 * @param properties
	 */
	public Emp(int empId, String empName, LinkedList<String> empCitys, Set<String> empOccupations,
	 ...
	 */
	public void setEmpCitys(LinkedList<String> empCitys) {
		this.empCitys = empCitys;
	}
	 ...
	 * @return the cources
	 */
	public HashMap<String, String> getCources() {
		return cources;
	}
	 ...
	 */
	public void setCources(HashMap<String, String> cources) {
		this.cources = cources;
	}
